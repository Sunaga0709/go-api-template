...
func TestError(t *testing.T) {
	...
	}{{ErrorKindUnknown, errorKindUnknownString, NewUnknownError}, {ErrorKindGet, errorKindGetString, NewGetError}, {ErrorKindUpdate, errorKindUpdateString, NewUpdateError}}
